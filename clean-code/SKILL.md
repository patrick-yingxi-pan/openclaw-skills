---
name: clean-code
description: Pragmatic coding standards - concise, direct, no over-engineering, no unnecessary comments. Use when writing code, refactoring, editing files, or doing any programming task to ensure clean, maintainable, and readable code following SOLID, DRY, KISS, and YAGNI principles.
