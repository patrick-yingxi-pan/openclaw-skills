---
name: reflect
description: Self-improvement through conversation analysis. Extracts learnings from corrections and success patterns, permanently encoding them into agent definitions. Philosophy - Correct once, never again. Use when you want to reflect on a conversation, review what was learned, extract insights from corrections, analyze success patterns, or improve the agent's behavior over time.
version: "2.0.0"
user-invocable: true
triggers:
  - reflect
